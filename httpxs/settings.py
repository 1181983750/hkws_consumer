...
#             'formatter': 'simple'
#         },
#         'request_logs': {  # 向文件中输出日志
#             'level': 'INFO',
#             'class': 'concurrent_log_handler.ConcurrentRotatingFileHandler',
#             'filename': os.path.join(os.path.dirname(BASE_DIR), Config.log_path),  # 日志文件的位置
...
#             'handlers': ['console', 'request_logs'],  # 可以同时向终端与文件中输出日志
#             'propagate': True,  # 是否继续传递日志信息
#             'level': 'INFO',  # 日志器接收的最低日志级别
#         },
#
#         'error': {
#             'handlers': ['error_logs'],  # 可以同时向终端与文件中输出日志
#             'propagate': True,  # 是否继续传递日志信息
#             'level': 'INFO',  # 日志器接收的最低日志级别
#         }
#     }
